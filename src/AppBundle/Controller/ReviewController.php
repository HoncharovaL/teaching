...
class ReviewController extends Controller
{
     ...
     *
     * @Route("/{idReview}", name="review_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idReview}/edit", name="review_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Review $review)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('review_edit', array('idReview' => $review->getIdreview()));
        }
     ...
     *
     * @Route("/{idReview}", name="review_delete")
     * @Method("DELETE")
     */
